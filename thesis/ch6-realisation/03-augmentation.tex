...
Pořízení záznamu artikulačních dat často vyžaduje používaní dalšího zařízení (kamery, ultrazvuku, atp. \cite{Hueber2010}- %\cite{Brumberg2010} \cite{Fagan2008} \cite{Hirahara2010}
 \cite{Jorgensen2010}), nebo dokonce nutnost podstoupení dalšího operačního zákroku (magnety \cite{Hofe2011}).
...
K aktualizaci výsledků byl použit nejlepší model z části \ref{chap:realisation:augmentation:audio}, tedy ten s $2,5\mathrm{x}$ protaženými daty.
