...
\title{Rozpoznávání řeči pacientů po totální laryngektomii komunikujících pomocí elektrolarynxu}
\titleEN{Speech recognition of patients after total laryngectomy communicating by electrolarynx}

\papertype{Disertační práce}
\papertypeEN{Thesis}
...
\advisercaptionEN{Supervisor:}
\adviser{Prof. Ing. Josef Psutka, CSc.}  %replace with the full name of your adviser
\department{Katedra kybernetiky}
\departmentEN{Department of Cybernetics}
\departmentfieldcaption{Obor:}
\departmentfieldcaptionEN{Study field:}
\departmentfield{Kybernetika}
\departmentfieldEN{Cybernetics}
\faculty{Fakulta aplikovaných věd}
\facultyEN{Faculty of Applied Sciences}
\university{Západočeská univerzita v~Plzni}
\universityEN{University of West Bohemia}
...
\addbibresource[label=theiss]{./ch-bib/thesis.bib}
\addbibresource[label=ssi]{./ch-bib/ssi.bib}
\addbibresource[label=other]{./ch-bib/other.bib}
\addbibresource[label=author]{./ch-bib/author.bib}

\defbibheading{impact}{\section*{Impaktované články}}
\defbibheading{proceedings}{\section*{Příspěvky na konferencích}}
\defbibheading{sw}{\section*{Aplikační výsledky}}
...
% \addtocategory{lit_autor}{vsvec2010vyzkumna}
...
%\setcounter{page}{5}
% \begin{refsection}
\include{ch1-introduction/chapter}
\include{ch2-motivation/chapter}
\include{ch3-cause/chapter}
\include{ch4-asr/chapter}
\include{ch5-construction/chapter}
\include{ch6-realisation/chapter}
\include{ch7-conclusion/chapter}
...
\printbibliography[heading=bibliography,title={Seznam pou\v{z}it\'{e} literatury}]
% \end{refsection}
...
% \nocite{svec2014general}
% \nocite{stanislav2016automatic}
% \nocite{svec2017interactive}

% \printbibliography[heading=bibliography,category=lit_autor,title={Publikace autora spojené s~tématem práce},prefixnumbers={A}]
% \printbibliography[heading=bibliography,category=lit_autor,title={Publikace autora},prefixnumbers={A}]
% \printbibliography[keyword=author,title={Publikace autora},prefixnumbers={A}]
% \nocite{vsvec2010vyzkumna}

\chapter*{Seznam publikovaných prací}
\addcontentsline{toc}{chapter}{Seznam publikovaných prací}

\begin{refsection}[author]
  \nocite{*}
  % \printbibliography[keyword=author,title={Publikace autora},prefixnumbers={A}]
  % \addcontentsline{toc}{chapter}{Publikace autora}
  \printbibliography[heading=impact,keyword=impact,title={Publikace autora}]
\end{refsection}

\begin{refsection}[author]
  \nocite{*}
  \printbibliography[heading=proceedings,keyword=proceedings]
\end{refsection}

\begin{refsection}[author]
  \nocite{*}
  \printbibliography[heading=sw,keyword=sw]
\end{refsection}
