...
\submitted{Srpen 2019}  % degree conferral date (January, April, June, September, or November)
...
\include{ch1-introduction/chapter-introduction}
\include{ch2-cause/chapter-cause}
\include{ch3-current_tech/chapter-current_technologies}
\include{ch4-experiments/chapter-experiments}
\include{ch5-trainer/chapter-trainer}
\include{ch6-conclusion/chapter-conclusion}
